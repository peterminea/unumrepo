...
Random r1;
r1.Reseed();
char t, *tt, TEXT[80], G[1920], Q1[1920], I1[70] = "/TROTOM.NUM2";
...
FILE *f1, *F2;
mpz_t C[1540], unu, doi, trei, d, d1, p, J[1540], z[160], verifMpz[160], sumMpz[160], sumIntMpz[160], prodnum, catnum, SUMDOI[2580];
...
W = NTOT;
H = H1;
GEN(U, W, b, C, D, E, "/GIG.TXT");//P2.TXT, PRIME2.TXT.
K0 = K;
H2 = H;
D2 = D;
...
for(f = 0; f < U; f++)
	b1[f] = b[f];
INV(b1, C, H, D, E);
for(int i = 0; i < 580; i++) mpz_inits(SUMDOI[i], NULL);
