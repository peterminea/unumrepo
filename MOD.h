...
void SUSMODIFSUM1(char *Q, long PP2, int &W, FILE *f1, mpz_t unu, mpz_t d, mpz_t d1, mpz_t doi, gmp_ui *S2, gmp_ui *A2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], mpz_t sum, mpz_t imp, mpz_t mul, mpz_t p, gmp_ui *q, int g) {
/*
char t[8][1920];
int i = 1, i1 = 1, i2;
strcpy(t[0], Q);
...
void JOSMODIFSUM1(char *Q, long PP2, int W, FILE *f1, int f, int u, mpz_t imp, mpz_t mul, mpz_t unu, mpz_t d, mpz_t d1, mpz_t doi, mpz_t trei, gmp_ui *A2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], int g, mpz_t p, gmp_ui *q) {
/*
char t[8][1920];
int i = 1, i1 = 1, i2;
strcpy(t[0], Q);
...
void SUSMODSPAR1(char *Q, long PP2, FILE *f1, int &W, mpz_t unu, mpz_t d, mpz_t d1, mpz_t doi, gmp_ui *AG, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, mpz_t *sumdoi, int *doi1, int v, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], mpz_t summ, mpz_t imp, mpz_t mul, mpz_t p, gmp_ui *q, int *doiul, int sep) {
while(1) {
	mpz_set_str(unu, Q, 10);
...
void SUSMODSPAR2(char *Q, long PP2, FILE *f1, int &W, mpz_t unu, mpz_t d, mpz_t d1, mpz_t doi, gmp_ui *AG, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, FILE *F2, int *doi1, int v, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], mpz_t summ, mpz_t imp, mpz_t mul, mpz_t p, mpz_t *q, int *doiul, int sep) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));
...
void JOSMODSPAR1(char *Q, long PP2, FILE *f1, int &W, int f, int u, mpz_t imp, mpz_t mul, mpz_t unu, mpz_t d, mpz_t d1, mpz_t doi, mpz_t trei, gmp_ui *A5, gmp_ui *AG, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, mpz_t *sumdoi, int *doi1, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], mpz_t p, gmp_ui *q, int *doiul, int sep) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
...
void MODSPARSUM(char *Q, long PP2, FILE *f1, int &W, mpz_t unu, mpz_t d, mpz_t d1, mpz_t doi, mpz_t trei, gmp_ui *A5, gmp_ui *AG, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, gmp_ui *w1, gmp_ui *w2, gmp_ui *w3, int *doi1, int *doi2, int *doi3, int k, int knk, int nk, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, int *doi0, int *doiul, int *mem, int &sus, int &dir, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX[][MS1], int FACTAUX2[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], mpz_t imp, mpz_t mul, mpz_t p, mpz_t *q, gmp_ui *q0, int sep) {
	if(dir) {
...
void MODPSUSMARE(mpz_t unu, int q, gmp_ui j1, int j, gmp_ui k, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], mpz_t sum[][MAX1], mpz_t doi, int f, int *mem, mpz_t nr2, mpz_t nm2) {
	...
	mpz_divisible_ui_p(unu, div1[q][++j])? j = j : j--;
	if(j+j1 > mem[q]) {
		j -= (mem[q] - j1);//gmp_printf("%llu %d %d %d %d %Zd TEVEZ\n", mem[q], f, j, j1, j+j1, div[f][0]);
...
void SUSMODPRIMSUM1(char *Q, long PP2, FILE *f1, int &W, gmp_ui nr, gmp_ui nm, mpz_t unu, mpz_t doi, gmp_ui *A2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], mpz_t p, int g) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, g = mpz_scan1(unu, 0));	
...
void SUSMODPRIMSUM2(char *Q, long PP2, FILE *f1, int &W, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t unu, mpz_t doi, gmp_ui *A2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], mpz_t p, int g) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, g = mpz_scan1(unu, 0));
...
void SUSMODPRIMSUM3(char *Q, long PP2, FILE *f1, int &W, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t unu, mpz_t doi, gmp_ui *A2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], mpz_t sum[][MAX1], int *mem, FILE *F2, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], int FACTAUX[][MS1], mpz_t p, int g) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, g = mpz_scan1(unu, 0));
...
void JOSMODPRIMSUM1(char *Q, long PP2, FILE *f1, int W, int f, int u, gmp_ui nr1, gmp_ui nm1, mpz_t unu, mpz_t doi, gmp_ui *A2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], mpz_t p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
...
void JOSMODPRIMSUM2(char *Q, long PP2, FILE *f1, int W, int f, int u, gmp_ui nr1, gmp_ui nm1, mpz_t nr2, mpz_t nm2, mpz_t unu, mpz_t doi, gmp_ui *A2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], mpz_t p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
	...
	if(mpz_divisible_ui_p(unu, A2[f])) {
		...
		MODPRIMSUMJOS2(nr1, nm1, nr2, nm2, unu, doi, A2[f], div1, sum1, 0, Q, F2, FACT[f], FACTLEG[f], PRIMP[f], p);
	}
...
void JOSMODPRIMSUM3(char *Q, long PP2, FILE *f1, int W, int f, int u, gmp_ui nr1, gmp_ui nm1, mpz_t nm2, mpz_t nr2, mpz_t unu, mpz_t doi, gmp_ui *A2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, FILE *F2, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], mpz_t p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
...
void MODSUMSUS(int n, int z, int n1, gmp_ui nr, gmp_ui nm, gmp_ui nr1, gmp_ui nm1, int f, int R, mpz_t unu, mpz_t doi, mpz_t trei, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], char *Q, FILE *F2, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t p) {
	for(; n < f; n++) {		
		nr = nr1, nm = nm1;
		...
		mpz_mul_ui(doi, unu, mul[n]);
		
		for(n1 = 0; n1 < R; n1++) {
			if(mul[n] ^ imp[n1] && mpz_divisible_ui_p(doi, imp[n1])) {
				MODSUMJOS(nr, nm, doi, trei, imp[n1], div1[][MAX2], sum1[][MAX2], 0, Q, F2, BFACT[n1], BFACTLEG[n1], BPRIMP[n1], unu);//Nu p.
			}
		}
	}
}
...
void MODSUMSUS2(int n, int z, int n1, int z1, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, int f, int R, mpz_t unu, mpz_t doi, mpz_t trei, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], char *Q, FILE *F2, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t p) {
	for(n = 0; n < f; n++) {
		mpz_set_ui(nm2, nm);
		mpz_set_ui(nr2, nr);
		...
		for(n1 = 0; n1 < R; n1++) {
			if(mul[n] ^ imp[n1] && mpz_divisible_ui_p(doi, imp[n1])) {
				...
				for(z1 = 0; BFACT[z1]; z1++)
					MODPJOSM1(doi, BFACTLEG[n1][z1], BPRIMP[n1][z1], 2, div1, sum1, nr3, nm3);
	
				CMMJ(nr3, nm3, doi, trei, imp[n1], Q, F2);
			}
		}
	}
}
...
void MODSUMSUSUL(int n, int z, int n1, int z1, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, int f, int R, mpz_t unu, mpz_t doi, mpz_t trei, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], mpz_t sum[][MAX1], int *mem, char *Q, FILE *F2, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], int FACTAUX[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], mpz_t p) {//gmp_ui i;
	for(; n < f; n++) {
		mpz_set_ui(nr2, nr);
		mpz_set_ui(nm2, nm);
		...
		for(n1 = 0; n1 < R; n1++) {
			if(mul[n] ^ imp[n1] && mpz_divisible_ui_p(doi, imp[n1])) {
				...
				for(z1 = 0; BFACT[z1]; z1++)
					MODPJOSM1(doi, BFACTLEG[z1], BPRIMP[z1], 2, div1, sum1, nr3, nm3);

				for(z1 = 0; BSFACT[z1]; z1++)
					MODPJOSMARE(doi, BSFACTLEG[z1], BSPRIMP[z1], 0, div1, sum1, mem, nr3, nm3);
...
void MODPRIMSUMSUSUL1(int n, int z, int f, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t unu, mpz_t doi, mpz_t trei, gmp_ui *A2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, char *Q, FILE *F2, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], mpz_t p) {//gmp_ui i;
	while(1) {
		mpz_set_ui(nr2, nr);
		mpz_set_ui(nm2, nm);
...
void MODSUMSUSM(int n, int z, int n1, int z1, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, int knk, int bknk, mpz_t unu, mpz_t doi, mpz_t trei, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, char *Q, FILE *F2, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], int FACTAUX1[][MS1], int FACTAUX[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BFACT1[][MS], int BFACTLEG1[][MS1], int BPRIMP1[][MS1], int BFACTAUX[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], mpz_t p) {
	for(n = 0; n < knk; n++) {
		mpz_set_ui(nr2, nr);
		mpz_set_ui(nm2, nm);
		...
		for(n1 = 0; n1 < bknk; n1++) {
			if(mul[n] ^ imp[n1] && mpz_divisible_ui_p(doi, imp[n1])) {
				...
				for(z1 = 0; BFACT1[z1]; z1++)
					MODPJOSM1(p, BFACTLEG1[z1], BPRIMP1[z1], 2, div1, sum1, nr3, nm3);	
				for(i = 0; SFACT[z1]; z1++)
					MODPJOSMARE(p, BSFACTLEG[z1], BSPRIMP[z1], 0, div1, sum1, mem, nr3, nm3);
				for(i = 0; FACT[z1]; z1++)
					MODPJOSM0(p, doi, BFACTLEG[z1], BPRIMP[z1], BFACTAUX[z1], 2, div, sum, div1, sum1, mem, nr3, nm3);
...
void MODSUMSUSM0(int n, int z, int k, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, mpz_t unu, mpz_t doi, mpz_t trei, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, char *Q, FILE *F2, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], int FACTAUX[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], int BFACTAUX[][MS1], mpz_t p) {
	for(n = 0; n < k; n++) {
		mpz_set_ui(nr2, nr);
		mpz_set_ui(nm2, nm);
...
void MODSUMJOS(gmp_ui nr, gmp_ui nm, mpz_t unu, mpz_t doi, gmp_ui A1, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int i, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, mpz_t p) {	
	for(; FACT[i]; i++)
		MODPJOS0(p, FACTLEG[i], PRIMP[i], 2, div1, sum1, nr, nm);
...
void MODSUMJOS1(gmp_ui nr, gmp_ui nm, mpz_t unu, mpz_t doi, gmp_ui A1, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int i, int R, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t p) {	
	for(; FACT[i]; i++)
		MODPJOS0(p, FACTLEG[i], PRIMP[i], 2, div1, sum1, nr, nm);
	...
	for(i = 0; i < R; i++) {
		if(A1 ^ mul[i]) {
			for(z = 0; BFACT[i][z]; z++)
			mpz_divisible_ui_p(doi, FACT[i][z])?
				MODPSUS0(doi, BFACTLEG[i][z], BPRIMP[i][z], div1, sum1, nr, nm, 2, 0)
					: MODPSUS1(BFACTLEG[i][z], BPRIMP[i][z], div1, sum1, nr, nm);
			
			CMMS0(doi, trei, mul[i], nr, nm, CMMDC(nr, nm, nr%nm), Q, F2);
		}
	}
}


void MODSUMJOS2(gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, mpz_t unu, mpz_t doi, gmp_ui A1, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int i, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t p) {
	mpz_set_ui(nr2, nr);
	mpz_set_ui(nm2, nm);
	...
	for(i = 0; i < R; i++) {
		if(A1 ^ mul[i]) {
			...
			for(z = 0; BFACT[n][z]; z++)
			mpz_divisible_ui_p(p, BFACT[n][z])?
				MODPSUSM2(p, BFACTLEG[n][z], BPRIMP[n][z], 2, 0, div1, sum1, nr3, nm3)
					: MODPSUSM1(BFACTLEG[n][z], BPRIMP[n][z], div1, sum1, nr3, nm3);
			
			CMMS(nr3, nm3, doi, trei, mul[i], Q, F2);
		}
	}
}


void MODSUMJOSUL(mpz_t unu, mpz_t doi, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, gmp_ui A1, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, int i, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, gmp_ui *SFACT, int *SFACTLEG, int *SPRIMP, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], mpz_t p) {
	mpz_set_ui(nr2, nr);
	mpz_set_ui(nm2, nm);
	...
	for(i = 0; i < R; i++) {
		...
		for(z = 0; BFACT[i][z]; z++)
			mpz_divisible_ui_p(p, BFACT[i][z])?
				MODPSUSM2(p, BFACTLEG[i][z], BPRIMP[i][z], 2, 0, div1, sum1, nr3, nm3)
					: MODPSUSM1(BFACTLEG[i][z], BPRIMP[i][z], div1, sum1, nr3, nm3);
					
		for(z = 0; BSFACT[i][z]; z++)
			if(mpz_divisible_ui_p(p, BSFACT[i][z])) {
				MODPSUSMARE(p, BSFACTLEG[i][z], BSPRIMP[i][z], 0, 0, div1, sum1, sum, doi, BFACTAUX[i][z], mem, nr3, nm3);
				}
			else
				MODPSUSM1(BSFACTLEG[i][z], BSPRIMP[i][z], div1, sum1, nr3, nm3);
...
void MODSUMJOSM(mpz_t unu, mpz_t doi, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, gmp_ui A1, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, int i, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, gmp_ui *FACT1, int *FACTLEG1, int *PRIMP1, int *FACTAUX, gmp_ui *SFACT, int *SFACTLEG, int *SPRIMP, gmp_ui *mul, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BFACT1[][MS], int BFACTLEG1[][MS1], int BPRIMP1[][MS1], int BFACTAUX[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], mpz_t p) {
	mpz_set_ui(nr2, nr);
	mpz_set_ui(nm2, nm);
	...
	for(i = 0; i < R; i++) {
		if(A1 ^ mul[i]) {
			...
			for(z = 0; BFACT1[i][z]; z++)
			mpz_divisible_ui_p(p, BFACT1[i][z])?
				MODPSUSM2(p, BFACTLEG1[i][z], BPRIMP1[i][z], 2, 0, div1, sum1, nr3, nm3)
					: MODPSUSM1(BFACTLEG1[i][z], BPRIMP1[i][z], div1, sum1, nr3, nm3);	
			for(z = 0; SFACT[i][z]; z++)
				if(mpz_divisible_ui_p(p, BSFACT[i][z])) {
					MODPSUSMARE(p, BSFACTLEG[i][z], BSPRIMP[i][z], 0, 0, div1, sum1, sum, doi, BFACTAUX1[i][z], mem, nr3, nm3);
					}
					else
					MODPSUSM1(BSFACTLEG[i][z], BSPRIMP[i][z], div1, sum1, nr3, nm3);	
			for(z = 0; FACT[i][z]; z++)
				if(mpz_divisible_ui_p(p, BFACT[i][z])) {
					MODPSUSM0(p, BFACTLEG[i][z], BPRIMP[i][z], BFACTAUX[i][z], 2, 0, div, sum, div1, sum1, mem, doi, nr3, nm3);
					}
					else
						 MODPSUSM1(BFACTLEG[i][z], BPRIMP[i][z], div1, sum1, nr3, nm3);
...
void MODSUMJOSM0(mpz_t unu, mpz_t doi, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, gmp_ui A1, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, int i, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, int *FACTAUX, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], int BFACTAUX[][MS1], mpz_t p) {
	mpz_set_ui(nr2, nr);
	mpz_set_ui(nm2, nm);
	...
	for(i = 0; i < R; i++) {
		if(A1 ^ mul[i]) {
			...
			for(z = 0; BFACT[n][z]; z++)
			if(mpz_divisible_ui_p(doi, BFACT[n][z])) {
				MODPSUSM0(doi, BFACTLEG[n][z], BPRIMP[n][z], BFACTAUX[n][z], 2, 0, div, sum, div1, sum1, mem, doi, nr3, nm3);
				}
				else
				MODPSUSM1(BFACTLEG[n][z], BPRIMP[n][z], div1, sum1, nr3, nm3);
			
			CMMS(nr3, nm3, doi, trei, A2[n], Q, F2);
		}
	}
}


void SUSMODSUMUL(mpz_t unu, mpz_t doi, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, int k, int knk, int nk, char *Q, FILE *F2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], mpz_t div[][MAX1], mpz_t sum[][MAX1], int *mem, gmp_ui nr, gmp_ui nm, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX[][MS1], int FACTAUX1[][MS1], int FACTAUX2[][MS1], int FACTAUX3[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], mpz_t nr2, mpz_t nm2, mpz_t p) {
	MODSUMSUSM0(0, 0, k, nr, nm, nr2, nm2, nr3, nm3, unu, doi, m1, div, sum, div1, sum1, mem, Q, F2, mul, FACT, FACTLEG, PRIMP, FACTAUX, imp, BFACT, BFACTLEG, BPRIMP, BFACTAUX, p);
	MODSUMSUSM(0, 0, knk, nr, nm, nr2, nm2, nr3, nm3, unu, doi, m2, div, sum, div1, sum1, mem, Q, F2, mul, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX3, FACTAUX2, SFACT2, SFACTLEG2, SPRIMP2, imp, BFACT2, BFACTLEG2, BPRIMP2, BFACT3, BFACTLEG3, BPRIMP3, BFACTAUX3, BFACTAUX2, BSFACT2, BSFACTLEG2, BSPRIMP2, p);
	MODSUMSUSUL(0, 0, nk, nr, nm, nr2, nm2, nr3, nm3, unu, doi, m3, div1, sum1, sum, FACTAUX1, mem, Q, F2, mul, FACT1, FACTLEG1, PRIMP1, SFACT, SFACTLEG, SPRIMP, imp, BFACT1, BFACTLEG1, BPRIMP1, BSFACT, BSFACTLEG, BSPRIMP, p);
	//MODSUMSUSUL1(0, 0, nk, nr, nm, unu, doi, m3, div1, sum1, mem, Q, F2, FACT1, FACTLEG1, PRIMP1, SFACT, SFACTLEG, SPRIMP, nr2, nm2, p);
}


void JOSMODSUMUL(int W, mpz_t unu, mpz_t doi, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, int k, int knk, int nk, char *Q, FILE *F2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], mpz_t div[][MAX1], mpz_t sum[][MAX1], int *mem, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX[][MS1], int FACTAUX2[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], mpz_t nr2, mpz_t nm2, gmp_ui nr1, gmp_ui nm1, mpz_t p) {	
	for(W = k-1; W >= 0; --W)
	if(mpz_divisible_ui_p(p, m1[W])) {
		MODPRIMSUMJOSM0(unu, doi, nr1, nm1, nr2, nm2, nr3, nm3, m1[W], div, sum, div1, sum1, mem, 0, Q, F2, FACT[W], FACTLEG[W], PRIMP[W], FACTAUX[W], mul, BFACT, BFACTLEG, BPRIMP, BFACTAUX, p);
	}
	
	for(W = knk-1; W >= 0; --W)
	if(mpz_divisible_ui_p(p, m2[W])) {
		MODPRIMSUMJOSM(unu, doi, nr1, nm1, nr2, nm2, nr3, nm3, m2[W], div, sum, div1, sum1, mem, 0, Q, F2, FACT2[W], FACTLEG2[W], PRIMP2[W], FACT3[W], FACTLEG3[W], PRIMP3[W], FACTAUX2[W], SFACT2[W], SFACTLEG2[W], SPRIMP2[W], mul, BFACT2, BFACTLEG2, BPRIMP2, BFACT3, BFACTLEG3, BPRIMP3, BFACTAUX2, BSFACT2, BSFACTLEG2, BSPRIMP2, p);		
	}
	
	for(W = nk-1; W >= 0; --W)
	if(mpz_divisible_ui_p(p, m3[W])) {
		MODPRIMSUMJOSUL(unu, doi, nr1, nm1, nr2, nm2, nr3, nm3, m3[W], div1, sum1, mem, 0, Q, F2, FACT1[W], FACTLEG1[W], PRIMP1[W], SFACT[W], SFACTLEG[W], SPRIMP[W], mul, BFACT1, BFACTLEG1, BPRIMP1, BSFACT, BSFACTLEG, BSPRIMP,p);
	}
}


void SUSMOD1(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t trei, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], gmp_ui nr, gmp_ui nm, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));	
	MODSUMSUS(0, 0, 0, 0, 0, 0, nr, nm, f, R, unu, doi, trei, mul, imp, div1, sum1, Q, F2, FACT, FACTLEG, PRIMP, BFACT, BFACTLEG, BPRIMP, p);
	if(!(ftell(f1) ^ PP2))
		break;
	fseek(f1, 1, SEEK_CUR);
	fgets(Q, 1920, f1);
...
void SUSMOD2(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));
	MODSUMSUS2(0, 0, 0, 0, nr, nm, nr2, nm2, f, R, unu, doi, imp, mul, div1, sum1, Q, F2, FACT, FACTLEG, PRIMP, p);
	if(!(ftell(f1) ^ PP2))
		break;
	fseek(f1, 1, SEEK_CUR);
	fgets(Q, 1920, f1);
...
void SUSMOD3(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], int FACTAUX[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], int BFACTAUX[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));
	//MODSUMSUSUL1(0, 0, W, nr, nm, unu, doi, A2, div1, sum1, mem, Q, F2, FACT, FACTLEG, PRIMP, SFACT, SFACTLEG, SPRIMP, nr2, nm2, p);
	MODSUMSUSUL(0, 0, W, nr, nm, unu, doi, A2, div1, sum1, sum, FACTAUX, mem, Q, F2, FACT, FACTLEG, PRIMP, SFACT, SFACTLEG, SPRIMP, nr2, nm2, p);
	if(!(ftell(f1) ^ PP2))
		break;
	fseek(f1, 1, SEEK_CUR);
	fgets(Q, 1920, f1);
...
void SUSMOD4(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int f, int R, int W, int u, gmp_ui *mul, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, int k, int knk, int nk, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX[][MS1], int FACTAUX1[][MS1], int FACTAUX2[][MS1], int FACTAUX3[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], gmp_ui *imp, gmp_ui *bm1, gmp_ui *bm2, gmp_ui *bm3, int bk, int bknk, int bnk, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BFACT1[][MS], int BFACTLEG1[][MS1], int BPRIMP1[][MS1], gmp_ui BFACT2[][MS], int BFACTLEG2[][MS1], int BPRIMP2[][MS1], gmp_ui BFACT3[][MS], int BFACTLEG3[][MS1], int BPRIMP3[][MS1], int BFACTAUX[][MS1], int BFACTAUX1[][MS1], int BFACTAUX2[][MS1], int BFACTAUX3[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], gmp_ui BSFACT2[][MS], int BSFACTLEG2[][MS1], int BSPRIMP2[][MS1], mpz_t *p) {
	while(1) {
		mpz_set_str(unu, Q, 10);
		mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));
		SUSMODSUMUL(unu, doi, m1, m2, m3, k, knk, nk, Q, F2, div1, sum1, div, sum, mem, nr, nm, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX, FACTAUX1, FACTAUX2, FACTAUX3, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, nr2, nm2, p);
		if(!(ftell(f1) ^ PP2))
			break;
		fseek(f1, 1, SEEK_CUR);
		fgets(Q, 1920, f1);
...
void JOSMOD1(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], gmp_ui nr, gmp_ui nm, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
	...
	if(mpz_divisible_ui_p(unu, A2[f])) {
		...
		MODSUMJOS(nr1, nm1, unu, doi, A2[f], div1, sum1, 0, Q, F2, FACT[f], FACTLEG[f], PRIMP[f], p);
	}
...
void JOSMOD2(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
	...
	if(mpz_divisible_ui_p(unu, A2[f])) {
		...
		MODSUMJOS2(nr1, nm1, nr2, nm2, unu, doi, A2[f], div1, sum1, 0, Q, F2, FACT[f], FACTLEG[f], PRIMP[f], p);
	}
...
void JOSMOD3(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], int FACTAUX[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], int BFACTAUX[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
	...
	if(mpz_divisible_ui_p(unu, A2[f])) {
		...
		MODSUMJOSUL(unu, doi, nr1, nm1, nr2, nm2, A2[f], div1, sum1, mem, 0, Q, F2, FACT[f], FACTLEG[f], PRIMP[f], SFACT[f], SFACTLEG[f], SPRIMP[f], p);
	}
...
void JOSMOD4(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int f, int R, int W, int u, gmp_ui *mul, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, int k, int knk, int nk, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX1[][MS1], int FACTAUX2[][MS1], int FACTAUX3[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], int FACTAUX[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], int BFACTAUX[][MS1], mpz_t *p) {
	while(1) {
		mpz_set_str(unu, Q, 10);
		u = W;
		while(1) {
			...
			if(mpz_divisible_ui_p(unu, A2[--u])) {
				mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));
				JOSMODSUMUL(W, unu, doi, m1, m2, m3, k, knk, nk, Q, F2, div1, sum1, div, sum, mem, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX, FACTAUX2, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, nr2, nm2, nr1, nm1, p);
				break;
				}
			}
...
void MOD(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, int k, int knk, int nk, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX[][MS1], int FACTAUX1[][MS1], int FACTAUX2[][MS1], int FACTAUX3[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], gmp_ui *imp, gmp_ui *bm1, gmp_ui *bm2, gmp_ui *bm3, int bk, int bknk, int bnk, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BFACT1[][MS], int BFACTLEG1[][MS1], int BPRIMP1[][MS1], gmp_ui BFACT2[][MS], int BFACTLEG2[][MS1], int BPRIMP2[][MS1], gmp_ui BFACT3[][MS], int BFACTLEG3[][MS1], int BPRIMP3[][MS1], int BFACTAUX[][MS1], int BFACTAUX1[][MS1], int BFACTAUX2[][MS1], int BFACTAUX3[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], gmp_ui BSFACT2[][MS], int BSFACTLEG2[][MS1], int BSPRIMP2[][MS1], mpz_t *p) {
		if(dir) {
		sus < 55? SUSMOD1(Q, PP2, f1, F2, unu, doi, div1, sum1, nr, nm, f, R, W, u, mul, FACT, FACTLEG, PRIMP, imp, BFACT, BFACTLEG, BPRIMP, p)
		: sus < 163? SUSMOD2(Q, PP2, f1, F2, unu, doi, div1, sum1, nr, nm, nr2, nm2, f, R, W, u, mul, FACT, FACTLEG, PRIMP, imp, BFACT, BFACTLEG, BPRIMP, p)
			: sus < 223? SUSMOD3(Q, PP2, f1, F2, unu, doi, div1, sum1, mem, nr, nm, nr2, nm2, f, R, W, u, mul, FACT, FACTLEG, PRIMP, SFACT, SFACTLEG, SPRIMP, FACTAUX1, imp, BFACT, BFACTLEG, BPRIMP, BSFACT, BSFACTLEG, BSPRIMP, BFACTAUX1, p)
				: SUSMOD4(Q, PP2, f1, F2, unu, doi, div, sum, div1, sum1, mem, nr, nm, nr2, nm2, f, R, W, u, mul, m1, m2, m3, k, knk, nk, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX, FACTAUX1, FACTAUX2, FACTAUX3, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, imp, bm1, bm2, bm3, bk, bknk, bnk, BFACT, BFACTLEG, BPRIMP, BFACT1, BFACTLEG1, BPRIMP1, BFACT2, FACTLEG2, BPRIMP2, BFACT3, BFACTLEG3, BPRIMP3, BFACTAUX, BFACTAUX1, BFACTAUX2, BFACTAUX3, BSFACT, BSFACTLEG, BSPRIMP, BSFACT2, BSFACTLEG2, BSPRIMP2, p);
		} else {
		sus < 55? JOSMOD1(Q, PP2, f1, F2, unu, doi, div1, sum1, nr, nm, f, R, W, u, mul, FACT, FACTLEG, PRIMP, imp, BFACT, BFACTLEG, BPRIMP, p)
		: sus < 163? JOSMOD2(Q, PP2, f1, F2, unu, doi, div1, sum1, nr, nm, nr2, nm2, f, R, W, u, mul, FACT, FACTLEG, PRIMP, imp, BFACT, BFACTLEG, BPRIMP, p)
			: sus < 223? JOSMOD3(Q, PP2, f1, F2, unu, doi, div1, sum1, mem, nr, nm, nr2, nm2, f, R, W, u, mul, FACT, FACTLEG, PRIMP, SFACT, SFACTLEG, SPRIMP, FACTAUX1, imp, BFACT, BFACTLEG, BPRIMP, BSFACT, BSFACTLEG, BSPRIMP, BFACTAUX1, p)
			: JOSMOD4(Q, PP2, f1, F2, unu, doi, div, sum, div1, sum1, mem, nr, nm, nr2, nm2, f, R, W, u, mul, m1, m2, m3, k, knk, nk, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX, FACTAUX1, FACTAUX2, FACTAUX3, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, imp, bm1, bm2, bm3, bk, bknk, bnk, BFACT, BFACTLEG, BPRIMP, BFACT1, BFACTLEG1, BPRIMP1, BFACT2, FACTLEG2, BPRIMP2, BFACT3, BFACTLEG3, BPRIMP3, BFACTAUX, BFACTAUX1, BFACTAUX2, BFACTAUX3, BSFACT, BSFACTLEG, BSPRIMP, BSFACT2, BSFACTLEG2, BSPRIMP2, p);
	}
}


void PARSUMSUS(int n, int z, int n1, gmp_ui nr, gmp_ui nm, gmp_ui nr1, gmp_ui nm1, int f, int R, mpz_t unu, mpz_t doi, mpz_t trei, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], char *Q, FILE *F2, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui *sumdoi1, int *doi1, int j, mpz_t p) {
	for(; n < f; n++) {		
		nr = nr1, nm = nm1;
		MODPDOISUS(doi1[n], j, nr1 = nr, nm1 = nm, sumdoi1);
...
void PARSUMSUS2(int n, int z, int n1, int z1, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, int f, int R, mpz_t unu, mpz_t doi, mpz_t trei, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], char *Q, FILE *F2, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t *sumdoi, gmp_ui *sumdoi1, int *doi1, int j, mpz_t p) {
	for(n = 0; n < f; n++) {
		mpz_set_ui(nm2, nm);
		mpz_set_ui(nr2, nr);
		...
		for(n1 = 0; n1 < R; n1++) {
			if(mul[n] ^ imp[n1] && mpz_divisible_ui_p(doi, imp[n1])) {
				mpz_set(nr3, nr2);
				mpz_set(nm3, nm2);
				MODPDOIJOSM(doi1[n1], trei, sumdoi[j], sumdoi1, nr3, nm3);
...
void PARSUMSUSUL(int n, int z, int n1, int z1, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, int f, int R, mpz_t unu, mpz_t doi, mpz_t trei, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], mpz_t sum[][MAX1], int *mem, char *Q, FILE *F2, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], int FACTAUX[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], mpz_t *sumdoi, gmp_ui *sumdoi1, int *doi1, int j, mpz_t p) {
	for(; n < f; n++) {
		mpz_set_ui(nr2, nr);
		mpz_set_ui(nm2, nm);
		MODPDOISUSM(doi1[n], doi, j, sumdoi, sumdoi1, nr2, nm2);
...
void PARSUMSUSM(int n, int z, int n1, int z1, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, int knk, int bknk, mpz_t unu, mpz_t doi, mpz_t trei, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, char *Q, FILE *F2, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], int FACTAUX1[][MS1], int FACTAUX[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BFACT1[][MS], int BFACTLEG1[][MS1], int BPRIMP1[][MS1], int BFACTAUX[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], mpz_t *sumdoi, gmp_ui *sumdoi1, int *doi1, int j, mpz_t p) {
	for(n = 0; n < knk; n++) {
		mpz_set_ui(nr2, nr);
		mpz_set_ui(nm2, nm);
		MODPDOISUSM(doi1[n], doi, j, sumdoi, sumdoi1, nr2, nm2);
...
void PARSUMSUSM0(int n, int z, int k, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, mpz_t unu, mpz_t doi, mpz_t trei, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, char *Q, FILE *F2, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], int FACTAUX[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], int BFACTAUX[][MS1], mpz_t *sumdoi, gmp_ui *sumdoi1, int *doi1, int j, mpz_t p) {//j e scan1.
	for(n = 0; n < k; n++) {
		mpz_set_ui(nr2, nr);
		mpz_set_ui(nm2, nm);
		MODPDOISUSM(doi1[n], doi, j, sumdoi, sumdoi1, nr2, nm2);
...
void PARSUMJOS(gmp_ui nr, gmp_ui nm, mpz_t unu, mpz_t doi, gmp_ui A1, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int i, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, mpz_t p) {	
	for(; FACT[i]; i++)
		MODPJOS0(p, FACTLEG[i], PRIMP[i], 2, div1, sum1, nr, nm);
...
void PARSUMJOS1(gmp_ui nr, gmp_ui nm, gmp_ui nr1, gmp_ui nm1, mpz_t unu, mpz_t doi, gmp_ui A1, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int i, int R, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui *sumdoi1, int j, mpz_t p) {	
	MODPDOIJOS(p, j, nr, nm, sumdoi1);
	...
	for(i = 0; i < R; i++) {
		if(A1 ^ mul[i]) {
			...
			for(z = 0; BFACT[i][z]; z++)
			mpz_divisible_ui_p(doi, FACT[i][z])?
				MODPSUS0(doi, BFACTLEG[i][z], BPRIMP[i][z], div1, sum1, nr1, nm1, 2, 0)
					: MODPSUS1(BFACTLEG[i][z], BPRIMP[i][z], div1, sum1, nr1, nm1);
			
			CMMS0(doi, trei, mul[i], nr1, nm1, CMMDC(nr1, nm1, nr1%nm1), Q, F2);
		}
	}
}


void PARSUMJOS2(gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, mpz_t unu, mpz_t doi, gmp_ui A1, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int i, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t *sumdoi, gmp_ui *sumdoi1, int doi1, int *doiul, int j, mpz_t p) {
	mpz_set_ui(nr2, nr);
	mpz_set_ui(nm2, nm);
	...
	for(i = 0; i < R; i++) {
		if(A1 ^ mul[i]) {
			mpz_set(nr3, nr2);
			mpz_set(nm3, nm2);
			MODPDOISUSM(doiul[i], trei, j, sumdoi, sumdoi1, nr3, nm3);
...
void PARSUMJOSUL(mpz_t unu, mpz_t doi, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, gmp_ui A1, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, int i, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, gmp_ui *SFACT, int *SFACTLEG, int *SPRIMP, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], mpz_t *sumdoi, gmp_ui *sumdoi1, int doi1, int *doiul, int j, mpz_t p) {
	mpz_set_ui(nr2, nr);
	mpz_set_ui(nm2, nm);
	MODPDOIJOSM(doi1, doi, sumdoi, sumdoi1, nr2, nm2);
...
void PARSUMJOSM(mpz_t unu, mpz_t doi, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, gmp_ui A1, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, int i, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, gmp_ui *FACT1, int *FACTLEG1, int *PRIMP1, int *FACTAUX, gmp_ui *SFACT, int *SFACTLEG, int *SPRIMP, gmp_ui *mul, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BFACT1[][MS], int BFACTLEG1[][MS1], int BPRIMP1[][MS1], int BFACTAUX[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], mpz_t *sumdoi, gmp_ui *sumdoi1, int doi1, int *doiul, int j, mpz_t p) {
	mpz_set_ui(nr2, nr);
	mpz_set_ui(nm2, nm);
	MODPDOIJOSM(doi1, doi, sumdoi, sumdoi1, nr2, nm2);
...
void PARSUMJOSM0(mpz_t unu, mpz_t doi, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t nr3, mpz_t nm3, gmp_ui A1, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, int i, char *Q, FILE *F2, gmp_ui *FACT, int *FACTLEG, int *PRIMP, int *FACTAUX, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], int BFACTAUX[][MS1], mpz_t *sumdoi, gmp_ui *sumdoi1, int doi1, int *doiul, int j, mpz_t p) {
	mpz_set_ui(nr2, nr);
	mpz_set_ui(nm2, nm);
	MODPDOIJOSM(doi1, doi, sumdoi, sumdoi1, nr2, nm2);
...
void SUSPARSUMUL(mpz_t unu, mpz_t doi, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, int k, int knk, int nk, char *Q, FILE *F2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], mpz_t div[][MAX1], mpz_t sum[][MAX1], int *mem, gmp_ui nr, gmp_ui nm, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX[][MS1], int FACTAUX1[][MS1], int FACTAUX2[][MS1], int FACTAUX3[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], mpz_t nr2, mpz_t nm2, mpz_t p) {
	PARSUMSUSM0(0, 0, k, nr, nm, nr2, nm2, nr3, nm3, unu, doi, m1, div, sum, div1, sum1, mem, Q, F2, mul, FACT, FACTLEG, PRIMP, FACTAUX, imp, BFACT, BFACTLEG, BPRIMP, BFACTAUX, p);
	PARSUMSUSM(0, 0, knk, nr, nm, nr2, nm2, nr3, nm3, unu, doi, m2, div, sum, div1, sum1, mem, Q, F2, mul, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX3, FACTAUX2, SFACT2, SFACTLEG2, SPRIMP2, imp, BFACT2, BFACTLEG2, BPRIMP2, BFACT3, BFACTLEG3, BPRIMP3, BFACTAUX3, BFACTAUX2, BSFACT2, BSFACTLEG2, BSPRIMP2, p);
	PARSUMSUSUL(0, 0, nk, nr, nm, nr2, nm2, nr3, nm3, unu, doi, m3, div1, sum1, sum, FACTAUX1, mem, Q, F2, mul, FACT1, FACTLEG1, PRIMP1, SFACT, SFACTLEG, SPRIMP, imp, BFACT1, BFACTLEG1, BPRIMP1, BSFACT, BSFACTLEG, BSPRIMP, p);
	//MODSUMSUSUL1(0, 0, nk, nr, nm, unu, doi, m3, div1, sum1, mem, Q, F2, FACT1, FACTLEG1, PRIMP1, SFACT, SFACTLEG, SPRIMP, nr2, nm2, p);
}


void JOSPARSUMUL(int W, mpz_t unu, mpz_t doi, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, int k, int knk, int nk, char *Q, FILE *F2, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], mpz_t div[][MAX1], mpz_t sum[][MAX1], int *mem, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX[][MS1], int FACTAUX2[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], mpz_t nr2, mpz_t nm2, gmp_ui nr1, gmp_ui nm1, mpz_t p) {	
	for(W = k-1; W >= 0; --W)
	if(mpz_divisible_ui_p(p, m1[W])) {
		MODPARSUMJOSM0(unu, doi, nr1, nm1, nr2, nm2, nr3, nm3, m1[W], div, sum, div1, sum1, mem, 0, Q, F2, FACT[W], FACTLEG[W], PRIMP[W], FACTAUX[W], mul, BFACT, BFACTLEG, BPRIMP, BFACTAUX, p);
	}
	
	for(W = knk-1; W >= 0; --W)
	if(mpz_divisible_ui_p(p, m2[W])) {
		MODPARSUMJOSM(unu, doi, nr1, nm1, nr2, nm2, nr3, nm3, m2[W], div, sum, div1, sum1, mem, 0, Q, F2, FACT2[W], FACTLEG2[W], PRIMP2[W], FACT3[W], FACTLEG3[W], PRIMP3[W], FACTAUX2[W], SFACT2[W], SFACTLEG2[W], SPRIMP2[W], mul, BFACT2, BFACTLEG2, BPRIMP2, BFACT3, BFACTLEG3, BPRIMP3, BFACTAUX2, BSFACT2, BSFACTLEG2, BSPRIMP2, p);		
	}
	
	for(W = nk-1; W >= 0; --W)
	if(mpz_divisible_ui_p(p, m3[W])) {
		MODPARSUMJOSUL(unu, doi, nr1, nm1, nr2, nm2, nr3, nm3, m3[W], div1, sum1, mem, 0, Q, F2, FACT1[W], FACTLEG1[W], PRIMP1[W], SFACT[W], SFACTLEG[W], SPRIMP[W], mul, BFACT1, BFACTLEG1, BPRIMP1, BSFACT, BSFACTLEG, BSPRIMP,p);
	}
}


void SUSPAR1(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t trei, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], gmp_ui nr, gmp_ui nm, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));	
	PARSUMSUS(0, 0, 0, 0, 0, 0, nr, nm, f, R, unu, doi, trei, mul, imp, div1, sum1, Q, F2, FACT, FACTLEG, PRIMP, BFACT, BFACTLEG, BPRIMP, p);
	if(!(ftell(f1) ^ PP2))
		break;
	fseek(f1, 1, SEEK_CUR);
	fgets(Q, 1920, f1);
...
void SUSPAR2(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));
	PARSUMSUS2(0, 0, 0, 0, nr, nm, nr2, nm2, f, R, unu, doi, imp, mul, div1, sum1, Q, F2, FACT, FACTLEG, PRIMP, p);
	if(!(ftell(f1) ^ PP2))
		break;
	fseek(f1, 1, SEEK_CUR);
	fgets(Q, 1920, f1);
...
void SUSPAR3(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], int FACTAUX[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], int BFACTAUX[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));
	//MODSUMSUSUL1(0, 0, W, nr, nm, unu, doi, A2, div1, sum1, mem, Q, F2, FACT, FACTLEG, PRIMP, SFACT, SFACTLEG, SPRIMP, nr2, nm2, p);
	PARSUMSUSUL(0, 0, W, nr, nm, unu, doi, A2, div1, sum1, sum, FACTAUX, mem, Q, F2, FACT, FACTLEG, PRIMP, SFACT, SFACTLEG, SPRIMP, nr2, nm2, p);
	if(!(ftell(f1) ^ PP2))
		break;
	fseek(f1, 1, SEEK_CUR);
	fgets(Q, 1920, f1);
...
void SUSPAR4(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int f, int R, int W, int u, gmp_ui *mul, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, int k, int knk, int nk, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX[][MS1], int FACTAUX1[][MS1], int FACTAUX2[][MS1], int FACTAUX3[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], gmp_ui *imp, gmp_ui *bm1, gmp_ui *bm2, gmp_ui *bm3, int bk, int bknk, int bnk, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BFACT1[][MS], int BFACTLEG1[][MS1], int BPRIMP1[][MS1], gmp_ui BFACT2[][MS], int BFACTLEG2[][MS1], int BPRIMP2[][MS1], gmp_ui BFACT3[][MS], int BFACTLEG3[][MS1], int BPRIMP3[][MS1], int BFACTAUX[][MS1], int BFACTAUX1[][MS1], int BFACTAUX2[][MS1], int BFACTAUX3[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], gmp_ui BSFACT2[][MS], int BSFACTLEG2[][MS1], int BSPRIMP2[][MS1], mpz_t *p) {
	while(1) {
		mpz_set_str(unu, Q, 10);
		mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));
		SUSPARSUMUL(unu, doi, m1, m2, m3, k, knk, nk, Q, F2, div1, sum1, div, sum, mem, nr, nm, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX, FACTAUX1, FACTAUX2, FACTAUX3, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, nr2, nm2, p);
		if(!(ftell(f1) ^ PP2))
			break;
		fseek(f1, 1, SEEK_CUR);
		fgets(Q, 1920, f1);
...
void JOSPAR1(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], gmp_ui nr, gmp_ui nm, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
	...
	if(mpz_divisible_ui_p(unu, A2[f])) {
		...
		PARSUMJOS(nr1, nm1, unu, doi, A2[f], div1, sum1, 0, Q, F2, FACT[f], FACTLEG[f], PRIMP[f], p);
	}
...
void JOSPAR2(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
	...
	if(mpz_divisible_ui_p(unu, A2[f])) {
		...
		PARSUMJOS2(nr1, nm1, nr2, nm2, unu, doi, A2[f], div1, sum1, 0, Q, F2, FACT[f], FACTLEG[f], PRIMP[f], p);
	}
...
void JOSPAR3(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], int FACTAUX[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], int BFACTAUX[][MS1], mpz_t *p) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
	...
	if(mpz_divisible_ui_p(unu, A2[f])) {
		...
		PARSUMJOSUL(unu, doi, nr1, nm1, nr2, nm2, A2[f], div1, sum1, mem, 0, Q, F2, FACT[f], FACTLEG[f], PRIMP[f], SFACT[f], SFACTLEG[f], SPRIMP[f], p);
	}
...
void JOSPAR4(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int f, int R, int W, int u, gmp_ui *mul, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, int k, int knk, int nk, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX1[][MS1], int FACTAUX2[][MS1], int FACTAUX3[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], int FACTAUX[][MS1], gmp_ui *imp, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], int BFACTAUX[][MS1], mpz_t *p) {
	while(1) {
		mpz_set_str(unu, Q, 10);
		u = W;
		while(1) {
			...
			if(mpz_divisible_ui_p(unu, A2[--u])) {
				mpz_tdiv_q_2exp(p, unu, mpz_scan1(unu, 0));
				JOSPARSUMUL(W, unu, doi, m1, m2, m3, k, knk, nk, Q, F2, div1, sum1, div, sum, mem, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX, FACTAUX2, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, nr2, nm2, nr1, nm1, p);
				break;
				}
			}
...
void PAR(char *Q, gmp_ui PP2, FILE *f1, FILE *F2, mpz_t unu, mpz_t doi, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int r, int f, int R, int W, int u, gmp_ui *mul, gmp_ui *m1, gmp_ui *m2, gmp_ui *m3, int k, int knk, int nk, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX[][MS1], int FACTAUX1[][MS1], int FACTAUX2[][MS1], int FACTAUX3[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], gmp_ui *imp, gmp_ui *bm1, gmp_ui *bm2, gmp_ui *bm3, int bk, int bknk, int bnk, gmp_ui BFACT[][MS], int BFACTLEG[][MS1], int BPRIMP[][MS1], gmp_ui BFACT1[][MS], int BFACTLEG1[][MS1], int BPRIMP1[][MS1], gmp_ui BFACT2[][MS], int BFACTLEG2[][MS1], int BPRIMP2[][MS1], gmp_ui BFACT3[][MS], int BFACTLEG3[][MS1], int BPRIMP3[][MS1], int BFACTAUX[][MS1], int BFACTAUX1[][MS1], int BFACTAUX2[][MS1], int BFACTAUX3[][MS1], gmp_ui BSFACT[][MS], int BSFACTLEG[][MS1], int BSPRIMP[][MS1], gmp_ui BSFACT2[][MS], int BSFACTLEG2[][MS1], int BSPRIMP2[][MS1], mpz_t *p) {
		if(dir) {
		sus < 55? SUSPAR1(Q, PP2, f1, F2, unu, doi, div1, sum1, nr, nm, f, R, W, u, mul, FACT, FACTLEG, PRIMP, imp, BFACT, BFACTLEG, BPRIMP, p)
		: sus < 163? SUSPAR2(Q, PP2, f1, F2, unu, doi, div1, sum1, nr, nm, nr2, nm2, f, R, W, u, mul, FACT, FACTLEG, PRIMP, imp, BFACT, BFACTLEG, BPRIMP, p)
			: sus < 223? SUSPAR3(Q, PP2, f1, F2, unu, doi, div1, sum1, mem, nr, nm, nr2, nm2, f, R, W, u, mul, FACT, FACTLEG, PRIMP, SFACT, SFACTLEG, SPRIMP, FACTAUX1, imp, BFACT, BFACTLEG, BPRIMP, BSFACT, BSFACTLEG, BSPRIMP, BFACTAUX1, p)
				: SUSPAR4(Q, PP2, f1, F2, unu, doi, div, sum, div1, sum1, mem, nr, nm, nr2, nm2, f, R, W, u, mul, m1, m2, m3, k, knk, nk, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX, FACTAUX1, FACTAUX2, FACTAUX3, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, imp, bm1, bm2, bm3, bk, bknk, bnk, BFACT, BFACTLEG, BPRIMP, BFACT1, BFACTLEG1, BPRIMP1, BFACT2, FACTLEG2, BPRIMP2, BFACT3, BFACTLEG3, BPRIMP3, BFACTAUX, BFACTAUX1, BFACTAUX2, BFACTAUX3, BSFACT, BSFACTLEG, BSPRIMP, BSFACT2, BSFACTLEG2, BSPRIMP2, p);
		} else {
		sus < 55? JOSPAR1(Q, PP2, f1, F2, unu, doi, div1, sum1, nr, nm, f, R, W, u, mul, FACT, FACTLEG, PRIMP, imp, BFACT, BFACTLEG, BPRIMP, p)
		: sus < 163? JOSPAR2(Q, PP2, f1, F2, unu, doi, div1, sum1, nr, nm, nr2, nm2, f, R, W, u, mul, FACT, FACTLEG, PRIMP, imp, BFACT, BFACTLEG, BPRIMP, p)
			: sus < 223? JOSPAR3(Q, PP2, f1, F2, unu, doi, div1, sum1, mem, nr, nm, nr2, nm2, f, R, W, u, mul, FACT, FACTLEG, PRIMP, SFACT, SFACTLEG, SPRIMP, FACTAUX1, imp, BFACT, BFACTLEG, BPRIMP, BSFACT, BSFACTLEG, BSPRIMP, BFACTAUX1, p)
			: JOSPAR4(Q, PP2, f1, F2, unu, doi, div, sum, div1, sum1, mem, nr, nm, nr2, nm2, f, R, W, u, mul, m1, m2, m3, k, knk, nk, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX, FACTAUX1, FACTAUX2, FACTAUX3, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, imp, bm1, bm2, bm3, bk, bknk, bnk, BFACT, BFACTLEG, BPRIMP, BFACT1, BFACTLEG1, BPRIMP1, BFACT2, FACTLEG2, BPRIMP2, BFACT3, BFACTLEG3, BPRIMP3, BFACTAUX, BFACTAUX1, BFACTAUX2, BFACTAUX3, BSFACT, BSFACTLEG, BSPRIMP, BSFACT2, BSFACTLEG2, BSPRIMP2, p);
	}
}
...
void MODPARSUMSUSM(int n, int z, int knk, mpz_t unu, mpz_t doi, gmp_ui *w2, int *doi1, int j, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], int *mem, mpz_t *sumdoi, gmp_ui *sumdoi1, char *Q, FILE *F2, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], int FACTAUX[][MS1], int FACTAUX1[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t p) {
	...
	//SEPSUMSUS3(unu, doi, nr1, nm1, nr2, nm2, Q, F2, sumdoi, sumdoi1, A5, j, 0, sep);
}
...
void SUSMODPARSUM1(char *Q, long PP2, FILE *f1, int &W, mpz_t unu, mpz_t doi, gmp_ui *AG, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, gmp_ui *sumdoi1, int *doi1, gmp_ui nr, gmp_ui nm, int j, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], mpz_t p, gmp_ui *q, int *doiul, int sep) {
	while(1) {
		mpz_set_str(unu, Q, 10);
...
void SUSMODPARSUM2(char *Q, long PP2, FILE *f1, int &W, mpz_t unu, mpz_t doi, gmp_ui *AG, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, gmp_ui *sumdoi1, int *doi1, gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int j, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], mpz_t p, mpz_t *q, int *doiul, int sep) {
while(1) {
	mpz_set_str(unu, Q, 10);
	mpz_tdiv_q_2exp(p, unu, j = mpz_scan1(unu, 0));
...
void SUSMODPARSUM4(char *Q, long PP2, FILE *f1, mpz_t unu, mpz_t doi, gmp_ui *w1, gmp_ui *w2, gmp_ui *w3, int *doi1, int *doi2, int *doi3, int k, int knk, int nk, mpz_t div[][MAX1], mpz_t sum[][MAX1], gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, int *mem, gmp_ui *sumdoi1, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui FACT1[][MS], int FACTLEG1[][MS1], int PRIMP1[][MS1], gmp_ui FACT2[][MS], int FACTLEG2[][MS1], int PRIMP2[][MS1], gmp_ui FACT3[][MS], int FACTLEG3[][MS1], int PRIMP3[][MS1], int FACTAUX[][MS1], int FACTAUX1[][MS1], int FACTAUX2[][MS1], int FACTAUX3[][MS1], gmp_ui SFACT[][MS], int SFACTLEG[][MS1], int SPRIMP[][MS1], gmp_ui SFACT2[][MS], int SFACTLEG2[][MS1], int SPRIMP2[][MS1], gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, int j, mpz_t p, mpz_t *q, int *doiul, int sep) {	
	while(1) {
		mpz_set_str(unu, Q, 10);
		mpz_tdiv_q_2exp(p, unu, j = mpz_scan1(unu, 0));		
...
void JOSMODPARSUM1(char *Q, long PP2, FILE *f1, int &W, int f, int u, mpz_t unu, mpz_t doi, gmp_ui *A5, gmp_ui *AG, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, gmp_ui *sumdoi1, int *doi1, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui nr, gmp_ui nm, mpz_t p, gmp_ui *q, int *doiul, int sep) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
	for(f = W-1; f >= 0; --f)
...
void JOSMODPARSUM2(char *Q, long PP2, FILE *f1, int &W, int f, int u, mpz_t unu, mpz_t doi, gmp_ui *A5, gmp_ui *AG, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], FILE *F2, gmp_ui *sumdoi1, int *doi1, gmp_ui FACT[][MS], int FACTLEG[][MS1], int PRIMP[][MS1], gmp_ui nr, gmp_ui nm, mpz_t nr2, mpz_t nm2, mpz_t p, mpz_t *q, int *doiul, int sep) {
while(1) {
	mpz_set_str(unu, Q, 10);
	u = 0;
	for(f = W-1; f >= 0; --f)	
