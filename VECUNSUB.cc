...
Random r1;
r1.Reseed();
char t, *tt, TEXT[80], G[1920], Q1[1920], I1[70] = "/ACRONISO.NUM2";
int mem[H1], putImpl[FDIM], P[U], f, h, Y, W, D, E, e, H, K, l, I, r, pDoi, doiSus, s, S, S1, u, v, V, K0, H2, D2, ssq, gm, A2[FDIM], P1[U], jos = strtol(arg[1], &tt, 10), sus = strtol(arg[2], &tt, 10);
...
W = N1910;
H = H1;
GEN(U, W, b, C, D, E, "/CFV1910.TXT");//P2.TXT, PRIME2.TXT.
K0 = K;
H2 = H;
D2 = D;
...
if((sus == NUME(TEXT)) && (sus-jos == UNIT(NUME(TEXT))) && (arg[5][0] == '1')) {
	...
	PP1 = /*(jos == NUME(TEXT) - UNIT(NUME(TEXT)))? 0 : */URC1(f1, jos, Q1, t, 5000L, PP, '1');
	PP2 = sus ^ NUME(TEXT)? URC1(f1, sus, Q1, t, 5000L, PP, '1') : PP;
...
F2 = fopen(I1, "w");
printf("De scris: %s .\n", I1);
RECIDENTE(I1, TEXT, jos-2, sus-2, arg[0], (char *)"1", 0, 1, 1);
