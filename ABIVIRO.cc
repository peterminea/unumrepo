...
char t, *p1, TEXT[80], Q[1920], l1[50] = "/PALANTECO.NUM2";
mpz_t C[EV], C1[EV], div[KV][MAX1], sum[KV][MAX1], z[40], z1[40], unu, doi, d, d1, p, q[2580];
int D, E, H, K, S, dd, e2, h, k, s, L, f, I, R, r, f2[HV], jos = strtol(arg[1], &p1, 10), sus = strtol(arg[2], &p1, 10), mem[HV], josul, susul, josul1, susul1;
...
R = 0;
while(1) {// RO50BACX0000001541760000
	fscanf(f1, "%d", &e);
	if(e > susul || (R == FDIM))
		break;
...
ARANJMIN2(b, mul, D, R);
ARANJMIN2(b, imp, D, f);
printf("R cu f sunt acum %d și %d.\n", R, f);*/
