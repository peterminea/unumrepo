...
gmp_ui q0[64], b[D1], div1[HV][MAX2], sum1[HV][MAX2], A2[H1], AP[H1], A20[H1], AP0[H1], b1[D1], PP, PP1, PP2;
...
//f + f0 ^ 1?
	MODPRIMULE(Q, PP2, f1, W = f, M, M0, M1, f, W0 = f0, f0, 0, b, b1, C, C1, unu, doi, trei, d, d1, A2, A20, AP, AP0, div, sum, div1, sum1, mem, sum2, D, E, H, K, S, F2, p, q, q0, sus, r)
	//:
