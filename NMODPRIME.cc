...
gmp_ui nr, nm, q0[64], b[DV], div1[HV][MAX2], sum1[HV][MAX2], A2[HV], AP[HV], A20[KV], AP0[KV], b1[DV], PP, PP1, PP2;
char t, *tt, Q[1920], TEXT[80], l1[90] = "/run/media/root/T12/ZESTEZECE.NUM2";
...
//f + f0 > 0?
MODPRIME(Q, nr, nm, PP2, f1, W = f, M, M0, M1, f, W0 = f0, 0, unu, doi, A2, A20, AP, AP0, div, div1, sum1, mem, F2, p, sus, r)
//: UMODPRIME(Q, PP2, f1, M[0], M0[0], M1[0], b, b1, C, C1, unu, doi, trei, d, d1, A2[0], A20[0], AP[0], AP0[0], div, sum, div1, sum1, mem, D, E, H, K, S, SS, F2, p, sus, r)
;
REN1(l1);
printf("KAPUTT\n");
fclose(f1);
