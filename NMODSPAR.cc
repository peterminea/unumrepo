...
ARANJFACT(0, D, b, b1, u1, f, m1, A2, A3, doi0, e, H, 0, r, 0);
//printf("\n%d %d\n\n", f, u1);
//if(K) 
	INIT(H1, div, sum);
...
//W ^ 1 || sep ^ 1?
MODSPARSUM(Q, PP2, f1, W, unu, d, d1, doi, trei, A4, AG, m1, m2, m3, w1, w2, w3, doi1, doi2, doi3, k, knk, nk, div, sum, div1, sum1, F2, doi0, doiul, mem, sus, r, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX, FACTAUX2, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, imp, mul, p1, q1, q0, sep)
//:
