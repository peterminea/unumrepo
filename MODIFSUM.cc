...
char t, *tt, Q[1920], TEXT[80], l1[90] = "/run/media/root/10T/BAULEMBOIM.NUM2";
int A4[FDIM], mem[HV+60], f, L, W, I, R, r, u1, H2, H3, pp = 0, pp1 = 0, m, n, p, jos = strtol(arg[1], &tt, 10), sus = strtol(arg[2], &tt, 10), D, E, H, K, S, k, knk, nk;
gmp_ui q0[64], A2[FDIM], A3[FDIM], b[D1], b1[D1], div1[HV+60][MAX2], sum1[HV+60][MAX2], e = 0, PP, PP1, PP2, m1[FDIM], m2[FDIM], m3[FDIM], sm[FDIM], s1[FDIM], s2[FDIM], s3[FDIM];
FILE *f1, *F2;
...
//omp_set_num_threads(4);
	//W ^ 0?
	MODIFSUM(Q, PP2, W, f1, b, b1, C, C1, unu, d, d1, doi, trei, sm, s1, s2, s3, A2, m1, m2, m3, k, knk, nk, div, sum, div1, sum1, D, E, H, K, S, F2, mem, sus, r, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3,  PRIMP3, FACTAUX, FACTAUX2, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, imp, mul, p1, q, q0)
	//:
	//UMODIFSUM(Q, PP2, W, f1, b, b1, C, C1, unu, d, d1, doi, trei, sm[0], s1[0], s2[0], s3[0], A2[0], m1[0], m2[0], m3[0], k, knk, nk, div, sum, div1, sum1, D, E, H, K, F2, mem, sus, r, FACT[0], FACTLEG[0], PRIMP[0], FACT1[0], FACTLEG1[0], PRIMP1[0], FACT2[0], FACTLEG2[0], PRIMP2[0], FACT3[0], FACTLEG3[0],  PRIMP3[0], FACTAUX[0], FACTAUX2[0], imp, mul, p1, q, q0)
	;
