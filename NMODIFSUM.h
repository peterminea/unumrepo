...
/*
Joi, 11 ianuarie în 1996, în Paris la Notre-Dame au fost funeraliile lui François Maurice Adrien Marie Mitterrand.
Știți voi, acel președinte francez căruia protestatarii din București i-au strigat în aprilie 1991 „Iliescu-Roman, couple assassin!”.

La înmormântare au participat, printre alții, și regele Spaniei și „lă Prans Șarlă” al Engleziei, fără Diana lângă el.
Și pare-se că a fost și Iliescu, dar pe el nu l-a băgat nimeni în zeamă.

*** ÎNTREBAREA ZILEI ***

-De ce numele lui Putin nu este scris și în franceză tot așa, ci Poutine?
-Pentru că dacă l-ar scrie ca la noi, ar ieși ca o înjurătură.


Quel putain ce boudin! Légion étrangère.



Lucruri interzise în Legiunea Străină

- Nu ai voie să mănânci ciocolată în cameră sau cu chipiul verde pe cap.
Flotări pentru toată camera.
- Nu ai voie să nu îți faci patul la dungă dimineața ori să fii dezordonat cu încălțările.
- Nu ai voie să fii rasist cu colegul tău!
Acolo, toți sunteți ca puși la comun la fiert în aceeași oală. Dacă mergi la Aubagne sau la Castelnaudary și ai mofturi rasiste pe tine, în L.E. mulți purici nu faci.

- Nu ai voie să devii plângăcios dacă ți se spune că mama ta a murit.
Testele astea psihologice de reacție detașată te descalifică din Legiune dacă le pici.
- Nu este voie să te bați cu camaradul tău. Dacă faci una ca asta, riști să fii legat de el ca siamezii. „Vous apprenderez à vous aimer!”
- Nu ai voie să faci greșeli de franceză dacă ești considerat ca fiind „francofon”. Flotări drept pălitură de pedeapsă. Acolo poți fi chiar desemnat să îl înveți franceza pe câte un „exotic”, să-l ajuți la cursuri, care-s „ce mai cursuri” du français intensif.

- Nu ai voie să răspunzi când te ceartă gradatul, se înțelege.
- Nu ai voie să stai neras! Ca prospătură recrutată, trebuie să-ți tai părul ca un bărbat soldat obișnuit. Militarii mai avansați, cu ani grei pe plete, sau eventual cei trimiși prin jungla guyaneză, ăia DA - ultimii se poate chiar să aibă nevoie de excesul de păr drept protecție.
- Nu ai voie să vorbești la telefon sau pe „vazap” cu familia, când ești la recrutare sau la următoarele patru luni de instruire de la Castelnaudary. Detașare totală și militărească de familie.

- Nu este voie să te descurci prost pe la instrucție. Acolo sunteți toți pentru unul, unul pentru toți, iar proasta mișcare de grup se pedepsește cu flotări sau cu abdomene de forma „craci în craci”.
- Nu este voie să ai sub 17 sau peste 40 de ani la venire, să ai mulți dinți lipsă sau, în timpurile moderne, să ai antecedente penale prea grave, cum sunt crima și traficul de droguri. Mai pe vremuri, puteai scăpa în Legiune și cu un trecut foarte murdar, dar s-au impus limite.
- Nu este voie să ți se facă frică și să îți părăsești camarazii și ARMELE în timpul luptei. De altfel, și codul lor de onoare spune că nu vei face așa ceva.

*** BONUS-RĂUS *** Toamnelor și tomnișoarelor, lăsați băiețoșeala deoparte și stați departe de Legiunea Străină! Femeile care intră acolo - trebuie să fie deja membre ale armatei normale, nu recrute simple - au un veritabil psihic de amazoane. Est-ce que c'est clair?!

VOILA' DU BOUDIN!!!


*** ÎNTREBAREA ZILEI ***
-Care este diferența dintre adevăr și minciună?
-Cea dintre „5*6 - 7*4 = 2” și „5*6-7*4=92”.
...
void MODPJOS1(mpz_t unu, int q, gmp_ui k, gmp_ui j, gmp_ui div1[][MAX2], gmp_ui sum1[][MAX2], gmp_ui &nr, gmp_ui &nm, mpz_t nr2, mpz_t nm2) {
		for(; mpz_divisible_ui_p(unu, div1[q][j]); j += 2);
		nm *= (j = mpz_divisible_ui_p(unu, div1[q][--j])? sum1[q][j] : sum1[q][--j]), nr *= (j - sum1[q][k-1]);
		mpz_set_ui(nr2, nr);
		mpz_set_ui(nm2, nm);
