...
// ./CARONTE 80 90 /media/root/T2T/LPT90.LIT a (sau b) 10000000.
...
if(argv[4][0] == 'a') {
	...
	sprintf(TEXT, "./CARONTE %s %s %s %s %s", argv[1], argv[2], argv[3], "b", ELEM);
	system(TEXT);
	exit(0);
}
...
TOLIL(1, b1, TEXT, a, e, 0, W, b, C, EXP, D = 0, E = 0, L, (a1 > 2420? "/P2.TXT" : (a1 > 0? "/CFV1910.TXT" : "/PM.TXT")), a1);//a1 sub 0 pentru PM.TXT.
