...
mpz_t C[EV], C1[EV], div[KV+SV][MAX1], sum[KV+SV][MAX1], unu, doi, trei, d, d1, nr2, nm2, p1, q[2580];
gmp_ui b[DV], b1[DV], div1[HV][MAX2], sum1[HV][MAX2], nr, nm, PP, PP1, PP2, A2[FDIM], A3[FDIM], e, b2[DV], m1[FDIM], m2[FDIM], m3[FDIM], sm[FDIM], s1[FDIM], s2[FDIM], s3[FDIM], q0[64];
FILE *f1, *F2;
char t, *tt, TEXT[80], Q[1920], l1[70] = "/run/media/root/10T/CERBING.NUM2";
int mem[HV], H2, H3, L, A4[FDIM], pp = 0, pp1 = 0, m, n, p, D, E, H, K, S, f, W, I, R, r, u, u1, jos = strtol(arg[1], &tt, 10), sus = strtol(arg[2], &tt, 10), k, knk, nk;
...
//if(K)
	INIT(KV+SV, div, sum);
UNIFACTUS(sus, b, b1, C, C1, D, E, H, K+S, div, sum, div1, sum1, mem, q, q0, 1);//exit(0);
DIVNUM(f, u1, H, H2, K, S, b, s1, s2, s3, sm, m1, m2, m3, k, knk, nk, A2, A3, pp, m, n, p, D, div1, sum1, div, sum, d, d1, FACT, FACTLEG, FACT1, FACTLEG1, FACT2, FACTLEG2, FACT3, FACTLEG3, PRIMP, PRIMP1, PRIMP2, PRIMP3, FACTAUX, FACTAUX1, FACTAUX2, FACTAUX3, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2);//exit(0);
...
//W ^ 1?
MODPRIMSUM(Q, PP2, f1, W, f, u, unu, doi, A2, m1, m2, m3, k, knk, nk, div, sum, div1, sum1, F2, mem, nr, nm, sus, r, FACT, FACTLEG, PRIMP, FACT1, FACTLEG1, PRIMP1, FACT2, FACTLEG2, PRIMP2, FACT3, FACTLEG3, PRIMP3, FACTAUX, FACTAUX1, FACTAUX2, FACTAUX3, SFACT, SFACTLEG, SPRIMP, SFACT2, SFACTLEG2, SPRIMP2, nr2, nm2, p1, q, q0)
//:
